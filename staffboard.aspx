<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="staffboard.aspx.cs" EnableEventValidation="false" Inherits="umisportal.staffboard" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
	<meta charset="utf-8">
		...
		<div class="row">
			<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2">
				...
				<ul class="nav nav-pills flex-column sidebar-nav">
					<li class="nav-item"><a class="nav-link active" href="staffboard.aspx"><em class="fa fa-dashboard"></em> Dashboard <span class="sr-only">(current)</span></a></li>
					<li class="nav-item"  id="hide4" runat="server"><a class="nav-link" href="timeline.aspx">Add a Timeline</a></li>
					<li class="nav-item" id="hide1" runat="server"><a class="nav-link" href="bursary.aspx">Bursary</a></li>
					<li class="nav-item"><a class="nav-link" href="vote.aspx">Vote</a></li>
					<li class="nav-item" id="hide2" runat="server"><a class="nav-link" href="addstaffs.aspx">Add a Staff</a></li>
                    <li class="nav-item" id="hide6" runat="server"><a class="nav-link" href="addcourse.aspx">Add a Course</a></li>
                    <li class="nav-item" id="Li1" runat="server"><a class="nav-link" href="modifystudents.aspx">Modify Students</a></li>
                    <li class="nav-item" id="hide5" runat="server"><a class="nav-link" href="addstaff">View Registered Students</a></li>
                     <li class="nav-item" id="Li2" runat="server"><a class="nav-link" href="addstudents">Add Students</a></li>
					...
					<section class="row">
							<div class="col-md-12 col-lg-8">
								<div class="jumbotron" style="background-color:#f6f7fd">
                                    ...
                                    <p>Phone : <asp:Label ID="phonelabel" runat="server" Text=""></asp:Label></p>
                                    <p>Gender : <asp:Label ID="genderlabel" runat="server" Text=""></asp:Label></p>
                                    <p>Email : <asp:Label ID="emaillabel" runat="server" Text=""></asp:Label></p>
                                    <p>Department : <asp:Label ID="departmentlabel" runat="server" Text=""></asp:Label></p>
                                    
									<a class="btn btn-secondary" href="profile.aspx">Edit profile</a>
                                    <br /><br /><br /><br /><br />
                                    </div>
							...
							<div class="col-md-12 col-lg-4">
									...
									<div class="card-block">
                                        ...
                                        <div class="dropdown card-title-btn-container">
											...
											<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
												<a class="dropdown-item" href="timeline.aspx"><em class="fa fa-thumb-tack mr-1"></em> Update Timeline </a>
											<a class="dropdown-item" href="deletetimeline"><em class="fa fa-remove mr-1"></em> Delete Timeline</a></div>
										</div>
								...
								<div class="card mb-4">
									<div class="card-block">
										...
										<h6 class="card-subtitle mb-2 text-muted">Your checklist</h6>
