<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="timeline.aspx.cs" EnableEventValidation="false" Inherits="umisportal.timeline" %>
   ...
   width: 100%; /* for IE 6 */
    ...
    <script>
        function postsuccess() {
            alert("Timeline successfully Updated")
        }
    </script>
</head>
<body>
		...
		<div class="row">
			<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2">
				...
				<ul class="nav nav-pills flex-column sidebar-nav">
					...
					<li class="nav-item"><a class="nav-link active" href="timeline.aspx">Add a Timeline</a></li>
					<li class="nav-item"><a class="nav-link" href="bursary.aspx">Bursary</a></li>
			...
			<main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
				<header class="page-header row justify-center">
					...
					<section class="row">
						    ...
						    <div class="jumbotron" style="background-color:#f6f7fd">
									 ...
									 <h2 class="text-info text-center mb-4">Update the Timeline</h2>
                            <div class="form-group">
                                <input type="text" id="titleid" class="form-control" runat="server" name="Title" placeholder="Title"/>
                            </div>
                            <div class="form-group">
                                        <label for="topicid" class="form-control-label">Content</label>
                                        <textarea class="form-control" name="content" id="topicid" rows="4" runat="server"></textarea>
                                    </div>
                      <asp:Button ID="CreatePost" runat="server" Text="Create" Width="100px" OnClick="Button1_Click" CssClass="btn btn-secondary"/>
                                    </div>
				...
				<asp:GridView ID="GridView1"  PagerStyle-CssClass="text-secondary"  PagerSettings-CssClass="text-secondary" style="border:0px;"  runat="server" AutoGenerateColumns="false" AllowCustomPaging="False" AllowPaging="true" OnPageIndexChanging="OnPaging" PageSize="4" PagerSettings-PageButtonCount="5" PagerSettings-Mode="NextPreviousFirstLast" PagerSettings-FirstPageText="First" PagerSettings-LastPageText="Last" PagerSettings-NextPageText="Next" PagerSettings-PreviousPageText="Previous" OnRowDeleting="GridView1_RowDeleting" >
                 ...
                 <asp:TemplateField>
                 <ItemTemplate>
                     <asp:Button ID="Button1" runat="server" Text="Clear" CommandName="Delete"  CssClass="bg-secondary"/>
                 </ItemTemplate>
            </asp:TemplateField>
