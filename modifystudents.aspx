<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modifystudents.aspx.cs" EnableEventValidation="false" Inherits="umisportal.modifystudents" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
	<meta charset="utf-8">
		...
		<div class="row">
			<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2">
				...
				<ul class="nav nav-pills flex-column sidebar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="coursefees.aspx">Modify Students</a></li>
			...
			<main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
				<header class="page-header row justify-center">
					<div class="col-md-6 col-lg-8" >
						<h1 class="float-left text-center text-md-left text-secondary">Modify Students</h1>
					</div>
