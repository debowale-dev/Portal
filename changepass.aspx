<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="changepass.aspx.cs" EnableEventValidation="false" Inherits="umisportal.changepass" %>
		...
		<div class="row">
			<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2">
				...
				<ul class="nav nav-pills flex-column sidebar-nav">
					<li class="nav-item"><a class="nav-link" href="index.aspx"><em class="fa fa-dashboard"></em> Dashboard <span class="sr-only">(current)</span></a></li>
					<li class="nav-item"><a class="nav-link" href="widgets.html">Register for semester</a></li>
					<li class="nav-item"><a class="nav-link" href="charts.html">Register for class</a></li>
					...
					<li class="nav-item"><a class="nav-link" href="cards.html">Check financial approval</a></li>
                    <li class="nav-item"><a class="nav-link" href="forms.html">Book an Appointment</a></li>
					<li class="nav-item"><a class="nav-link active" href="changepass.aspx">Change your Password</a></li>
				</ul>
					...
					<section class="row">
                        <br /><br /><br /><br />
							<div class="col-md-12 col-lg-8">
                                ...
                                <input type="password" id="oldpass" runat="server" class="form-control" name="oldpassword" placeholder="Current Password"/>
                            </div>
                            <div class="form-group">
                                <input type="password" id="newpass" runat="server" class="form-control" name="newpassword" placeholder="New Password"/>
                            </div>

                <asp:Button ID="Button1" runat="server" Text="Change" CssClass="btn btn-info text-center" Width="110px" OnClick="Button1_Click" />
